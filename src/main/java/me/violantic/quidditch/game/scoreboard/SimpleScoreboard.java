package me.violantic.quidditch.game.scoreboard;
...
/**
 * CREDIT: https://gist.github.com/mkotb/d99eccdcc78a43ffb707
 *
 * Edited by: Ethan | @Violantic
 */
public class SimpleScoreboard {
    ...
    private Map.Entry<Team, OfflinePlayer> createTeam(String text, int pos) {
        ...
        teams.add(team);
        return new AbstractMap.SimpleEntry<Team, OfflinePlayer>(team, result);
    }
    ...
    public void update() {
        ...
        for (Map.Entry<String, Integer> text : scores.entrySet()) {
            ...
            if(t != null) {
                ...
                team = new AbstractMap.SimpleEntry<Team, OfflinePlayer>(t, cache.get(color));
